...
final _entities = <obx_int.ModelEntity>[
  obx_int.ModelEntity(
      id: const obx_int.IdUid(2, 3326443141908041524),
      name: 'Category',
      lastPropertyId: const obx_int.IdUid(2, 4826949761206515344),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
            id: const obx_int.IdUid(1, 6834914612599205583),
            name: 'id',
            type: 6,
            flags: 1),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(2, 4826949761206515344),
            name: 'title',
            type: 9,
            flags: 0)
      ],
  ...
  obx_int.ModelEntity(
      id: const obx_int.IdUid(3, 7450729832815460486),
      name: 'Transaction',
      lastPropertyId: const obx_int.IdUid(5, 4518770727780961065),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
            id: const obx_int.IdUid(1, 6119366930543319080),
            name: 'id',
            type: 6,
            flags: 1),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(2, 3354925679879324516),
            name: 'date',
            type: 10,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(3, 2492500800052053600),
            name: 'comment',
            type: 9,
            flags: 0),
        obx_int.ModelProperty(
            id: const obx_int.IdUid(4, 7093226760973492595),
            name: 'categoryId',
            type: 11,
            flags: 520,
            indexId: const obx_int.IdUid(1, 6470946465647924071),
...
obx_int.ModelDefinition getObjectBoxModel() {
  final model = obx_int.ModelInfo(
      entities: _entities,
      lastEntityId: const obx_int.IdUid(3, 7450729832815460486),
      lastIndexId: const obx_int.IdUid(1, 6470946465647924071),
      lastRelationId: const obx_int.IdUid(0, 0),
      lastSequenceId: const obx_int.IdUid(0, 0),
      retiredEntityUids: const [7481810026216915318],
      retiredIndexUids: const [],
      retiredPropertyUids: const [8383439996730593430, 1331016002731089815],
